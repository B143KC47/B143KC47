...
<div style="display: flex; flex-direction: column; gap: 12px; align-items: flex-start;">
  <div style="display: flex; align-items: center; gap: 12px;">
    <span style="color: #a1a1aa; min-width: 90px;">OpenReview:</span>
    <space><a href="https://openreview.net/profile?id=%7EHo_Tin_Ko2">
  ...
  <div style="display: flex; align-items: center; gap: 12px;">
    <span style="color: #a1a1aa; min-width: 90px;">知乎:</span>
    <space><a href="https://www.zhihu.com/people/B143KC47">
  ...
  <div style="display: flex; align-items: center; gap: 12px;">
    <span style="color: #a1a1aa; min-width: 90px;">CSDN:</span>
    <space><a href="https://blog.csdn.net/B143KC47?spm=1000.2115.3001.5343">
